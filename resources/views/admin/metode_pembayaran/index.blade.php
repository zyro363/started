...
<div class="min-height-200px">
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-credit-card"></i> List Data Metode Pembayaran</h2>
         </div>
         <div class="pull-right">
            <a href="/admin/metode-pembayaran/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
         </div>
      </div>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td class="text-center" width="15%">
                  <a href="/admin/metode-pembayaran/edit/{{$data->id}}"><button class="btn btn-success btn-xs"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit Data"></i></button></a>
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="form-group" style="font-size: 17px;">
               <label for="exampleInputUsername1">Nama Metode Pembayaran</label>
               <input class="form-control" value="{{$data->nama}}" readonly style="background-color: white;pointer-events: none;">
            </div>
            <div class="row mt-4">
               <div class="col-md-6">
                  <a href="/admin/metode-pembayaran/delete/{{$data->id}}" style="text-decoration: none;">
