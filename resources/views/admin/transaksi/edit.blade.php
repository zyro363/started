...
<div class="min-height-200px">
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-edit"></i> Form Edit Data Transaksi</h2>
         </div>
      </div>
      ...
      <form method="POST" action="/admin/transaksi/update/{{$transaksi->id}}">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
               <select name="id_metode" class="form-control" required>
                  ...
                  @foreach($metode as $m)
                     <option value="{{$m->id}}" {{$transaksi->id_metode == $m->id ? 'selected' : ''}}>{{$m->nama}}</option>
                  @endforeach
               </select>
            </div>
         </div>
         <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
               <input class="form-control" type="date" name="tanggal" value="{{$transaksi->tanggal}}" required>
            </div>
         </div>
         <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Pukul</label>
            <div class="col-sm-12 col-md-10">
               <input class="form-control" type="time" name="pukul" value="{{$transaksi->pukul}}" required>
            </div>
         </div>
         <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Nama Pelanggan</label>
            <div class="col-sm-12 col-md-10">
               <input class="form-control" type="text" name="nama" value="{{$transaksi->nama}}" placeholder="Masukkan nama pelanggan" required>
            </div>
         </div>
         <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Contact</label>
            <div class="col-sm-12 col-md-10">
               <input class="form-control" type="text" name="contact" value="{{$transaksi->contact}}" placeholder="Masukkan contact pelanggan" required>
            </div>
         </div>
            ...
            <div class="barang-item">
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <select name="barang[]" class="form-control barang-select" required>
                           ...
                           @foreach($barang as $b)
                              <option value="{{$b->id}}" data-harga="{{$b->harga}}" {{$detail->id_barang == $b->id ? 'selected' : ''}}>{{$b->nama}} - Rp {{number_format($b->harga, 0, ',', '.')}}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="form-group">
                        <label>Jumlah</label>
                        <input type="number" name="jumlah[]" class="form-control jumlah-input" value="{{$detail->jumlah}}" placeholder="Jumlah" required min="1">
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="form-group">
                        <label>Diskon</label>
                        <input type="number" name="diskon[]" class="form-control" value="{{$detail->diskon}}" placeholder="Diskon" min="0">
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="form-group">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
               <input class="form-control" type="number" name="potongan" value="{{$transaksi->potongan}}" placeholder="Masukkan potongan" min="0">
            </div>
         </div>
         <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Bayar</label>
            <div class="col-sm-12 col-md-10">
               <input class="form-control" type="number" name="bayar" value="{{$transaksi->bayar}}" placeholder="Masukkan jumlah bayar" required min="0">
            </div>
         </div>
         <div class="form-group row">
