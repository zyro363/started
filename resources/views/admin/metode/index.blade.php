...
<div class="min-height-200px">
         ...
         <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Data Metode</li>
               </ol>
            </nav>
         </div>
         <div class="col-md-6 col-sm-12">
            <div class="pull-right">
               <a href="/admin/metode/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-settings"></i> List Data Metode</h2>
         </div>
      </div>
          ...
          <tbody>
             ...
             <tr>
                ...
                <td class="text-center" width="15%">
                   <a href="/admin/metode/edit/{{$data->id}}"><button class="btn btn-success btn-xs"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit Data"></i></button></a>
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="form-group" style="font-size: 17px;">
               <label for="exampleInputUsername1">Nama Metode</label>
               <input class="form-control" value="{{$data->nama}}" readonly style="background-color: white;pointer-events: none;">
            </div>
            <div class="row mt-4">
               <div class="col-md-6">
                  <a href="/admin/metode/delete/{{$data->id}}" style="text-decoration: none;">
