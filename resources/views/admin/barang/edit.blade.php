...
<div class="min-height-200px">
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-box"></i> Form Edit Barang</h2>
         </div>
      </div>
      ...
      <form action="/admin/barang/update/{{$barang->id}}" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
            ...
            <input type="number" class="form-control" id="harga" name="harga" value="{{$barang->harga}}" placeholder="Masukkan harga barang" required>
         </div>
         <div class="form-group">
